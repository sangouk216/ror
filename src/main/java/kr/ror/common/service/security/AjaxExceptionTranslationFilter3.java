...
public class AjaxExceptionTranslationFilter3 extends ExceptionTranslationFilter {
	
		
	public AjaxExceptionTranslationFilter3(AuthenticationEntryPoint authenticationEntryPoint) {
