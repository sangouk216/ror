...
public class AjaxExceptionTranslationFilter2 extends ExceptionTranslationFilter {
	
		
	public AjaxExceptionTranslationFilter2(AuthenticationEntryPoint authenticationEntryPoint) {
